...
import { BookOpen, Users, BookCheck, AlertCircle, DollarSign, Clock } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  const loadStats = async () => {
    setLoading(true);
    const data = await statsAPI.getLibraryStats();
    setStats(data);
    setLoading(false);
  };
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">From fine payments</p>
          </CardContent>
        </Card>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-2">
            <a href="/admin/books" className="block text-sm text-primary hover:underline">
              Manage Books
            </a>
            <a href="/admin/members" className="block text-sm text-primary hover:underline">
              Manage Members
            </a>
            <a href="/admin/reports" className="block text-sm text-primary hover:underline">
              View Reports
            </a>
            <a href="/admin/settings" className="block text-sm text-primary hover:underline">
              System Settings
            </a>
          </CardContent>
        </Card>
